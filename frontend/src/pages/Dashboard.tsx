      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-white p-6 rounded-3xl border border-slate-200/80 shadow-sm">
          <div className="space-y-1">
            ...
            <p className="text-xs font-medium text-slate-500 pl-10">
          ...
          <Link
            to="/"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700 text-white font-bold text-xs shadow-md shadow-violet-500/20 active:scale-95 transition-all"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {statCards.map((card, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-sm space-y-3 relative overflow-hidden"
              >
        ...
        {/* Link List Section */}
        <div className="bg-white p-4 sm:p-8 rounded-3xl border border-slate-200/80 shadow-sm">
          <UrlHistory
